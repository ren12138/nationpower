	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnLogin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (usernameEditText.getText().toString().equals("ren")
		...
		/*
		 * btnLogin.setOnClickListener(new OnClickListener() { public void
		 * onClick(View v) { 此处用Intent来实现Activity与Activity之间的跳转 Intent intent =
		 * new Intent(); intent.setClass(MainActivity.this,
		 * HomePageActivity.class); startActivity(intent); } });
		 */
